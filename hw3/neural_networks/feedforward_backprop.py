...
def feedforward_backprop(data, label, weights):
    ...
    gradients = {}
    gradients['fully2_weight_grad'], gradients['fully2_bias_grad'], relu1_sensitivity = fullyconnect_backprop(
    ...
    gradients['fully1_weight_grad'], gradients['fully1_bias_grad'], _ = fullyconnect_backprop(
